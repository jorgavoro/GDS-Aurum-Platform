...
public class ProfitCenter extends AuditableEntity {
    ...
    public ProfitCenter(Long id, String code, String name, String description,
                        CostCenterStatus status, Boolean active, ChartOfAccounts chartOfAccounts) {
        this.id = id;
        this.code = code;
        this.name = name;
