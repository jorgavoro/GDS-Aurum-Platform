...
@Component
public class DefaultAnalyticalReportCalculator implements AnalyticalReportCalculator {
    ...
    @Override
    public BigDecimal calculateNetResult(List<LedgerEntry> entries) {
        return calculateRevenue(entries).subtract(calculateExpense(entries));
    }
}
