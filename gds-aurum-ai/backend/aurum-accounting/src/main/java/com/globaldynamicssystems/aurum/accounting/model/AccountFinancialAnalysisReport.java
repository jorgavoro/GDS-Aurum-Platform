...
public class AccountFinancialAnalysisReport {
    ...
    public AccountFinancialAnalysisReport() {
    }

    public AccountFinancialAnalysisReport(Long chartOfAccountsId,
                                          Long fiscalPeriodId,
                                          String fiscalPeriodName,
                                          List<AccountFinancialAnalysis> accounts,
                                          BigDecimal totalDebit,
                                          BigDecimal totalCredit,
                                          BigDecimal totalBalance,
                                          BigDecimal totalRevenue,
                                          BigDecimal totalExpense,
                                          BigDecimal totalNetResult) {
